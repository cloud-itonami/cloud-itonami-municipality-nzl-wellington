# cloud-itonami-municipality-nzl-wellington

Municipal-ordinance compliance catalog for **Wellington** — the
FORTY-FOURTH municipality-level entry alongside
...
[`cloud-itonami-municipality-aut-vienna`](https://github.com/cloud-itonami/cloud-itonami-municipality-aut-vienna),
...
New Zealand's first entry across any of the 3 axes.
...
government layer separate from its national government (unlike every
other municipality in this catalog), making it a poor structural fit
for this axis.
...
actuation actor. It proposes or executes nothing on Wellington City
Council's behalf.
...
Both entries directly confirmed via Wikipedia: Wellington's
incorporation as a city on **16 September 1870** (retroactively
confirmed by the Municipal Corporations Act 1886) and the current
Wellington City Council's establishment via the **1989** New Zealand
...
festivals and heritage sites for Wellington:
...
remains New Zealand's; this repo stores only citation metadata
